/*
Component to be attached to list addon lines.
*/

//----------------------------------------------------------------------------------------------
class WEXT_ListAddonLineComponent : ScriptedWidgetComponent
{
	protected ref WEXT_ListAddonLineWidgets widgets = new WEXT_ListAddonLineWidgets();
