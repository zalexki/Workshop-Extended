...
// Layout file: UI/AddonListTab/ListAddonLine.layout

class WEXT_ListAddonLineWidgets
{
	static const ResourceName s_sLayout = "{E363BEA40C56718E}UI/AddonListTab/ListAddonLine.layout";
